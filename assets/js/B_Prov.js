...
function updateAllUraian() {
  ...
  fetchQTQValue({
    baseUrl,
    uraian: "pertambangan minyak, gas dan panas bumi",
    judul: "tabel 4",
    targetId: "qtq_pertambangan_minyak_prov"
  });
  ...
  fetchQTQValue({
    ...
    uraian: "pertambangan minyak, gas dan panas bumi",
    judul: "tabel 5",
    targetId: "yoy_pertambangan_minyak_prov"
  });
  ...
  fetchQTQValue({
    ...
    uraian: "pertambangan minyak, gas dan panas bumi",
    judul: "tabel 6",
    targetId: "ctc_pertambangan_minyak_prov"
  });
