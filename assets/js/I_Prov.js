...
function updateAllUraian() {
  ...
  fetchQTQValue({
    baseUrl,
    uraian: "Penyediaan Akomodasi",
    judul: "tabel 4",
    targetId: "qtq_pengunjung_hotel_prov"
  });
  ...
  fetchQTQValue({
    ...
    uraian: "Penyediaan Akomodasi",
    judul: "tabel 5",
    targetId: "yoy_pengunjung_hotel_prov"
  });
  ...
  fetchQTQValue({
    ...
    uraian: "Penyediaan Akomodasi",
    judul: "tabel 6",
    targetId: "ctc_pengunjung_hotel_prov"
  });
  ...
  fetchQTQValue({
    ...
    judul: "tabel 4",
    targetId: "qtq_penyediaan_mamin_prov"
  });
  ...
  fetchQTQValue({
    ...
    uraian: "Penyediaan Makan Minum",
    judul: "tabel 5",
    targetId: "yoy_penyediaan_mamin_prov"
  });
  ...
  fetchQTQValue({
    ...
    uraian: "Penyediaan Makan Minum",
    judul: "tabel 6",
    targetId: "ctc_penyediaan_mamin_prov"
  });
}
