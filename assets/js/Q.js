...
const komoditasList = [
  {
    key: "fungsi_kesehatan",
    charts: [
      { id: "chart_fungsi_kesehatan", dataKey: "kesehatan" }
    ]
  },
  {
    key: "jumlah_pasien",
    charts: [
      { id: "chart_jumlah_pasien", dataKey: "pasien" },
      { id: "chart_jumlah_sarana", dataKey: "sarana" },
      { id: "chart_jumlah_tenagaKerja", dataKey: "tenagaKerja" }
    ]
  }
];
